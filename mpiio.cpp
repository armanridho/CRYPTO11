...
int reg2str(string s, const unit *n, short radix)
{
 ...
 */
short reg2mpi(register byte * buf, register const unit * r)
{
...
void dumpbuf(string s, byte * buf, int bytecount)
{
    putstr(s);
    while (bytecount--) {
	puthexbyte(*buf++);
